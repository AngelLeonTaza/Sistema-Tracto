...
class ModeloPedidosPiezas{

	//CREAR PEDIDO TRACTOR

	static public function mdlIngresarPedidosPiezas($tabla, $datos){
	...
	static public function mdlMostrarPedidosPiezas($tabla, $item, $valor){
	...
	static public function mdlEditarPedidoPieza($tabla, $datos){
	...
	static public function mdlBorrarPedidosPiezas($tabla, $datos){
