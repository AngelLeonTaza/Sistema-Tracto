...
class ModeloVentas{
	...
	static public function mdlIngresarVenta($tabla, $datos){
		...
		$stmt = Conexion::conectar()->prepare("INSERT INTO $tabla(codigo, id_cliente, id_vendedor, productos, impuesto, neto, total, tipo_comprobante, tipo_anticipo, anticipo, pagos, estado, prioridad,  metodo_pago) VALUES (:codigo, :id_cliente, :id_vendedor, :productos, :impuesto, :neto, :total, :tipo_comprobante, :tipo_anticipo, :anticipo, :pagos, :estado, :prioridad, :metodo_pago)");
		...
		$stmt->bindParam(":tipo_anticipo", $datos["tipo_anticipo"], PDO::PARAM_STR);
	...
	static public function mdlEditarVenta($tabla, $datos){
		...
		$stmt = Conexion::conectar()->prepare("UPDATE $tabla SET  id_cliente = :id_cliente, id_vendedor = :id_vendedor, productos = :productos, impuesto = :impuesto, neto = :neto, total= :total, metodo_pago = :metodo_pago, estado = :estado WHERE codigo = :codigo");
