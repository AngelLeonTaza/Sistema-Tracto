...
class ModeloPedidosTractores{

	//CREAR PEDIDO TRACTOR

	static public function mdlIngresarPedidosTractores($tabla, $datos){
	...
	static public function mdlMostrarPedidosTractores($tabla, $item, $valor){
	...
	static public function mdlEditarPedidoTractor($tabla, $datos){
	...
	static public function mdlBorrarPedidosTractores($tabla, $datos){
