<?php
	...
	$pdf->Image('img/tractores.png',10,7,72,27,'PNG');

	$pdf->Image('img/logo_tractoleo.png',85,7,52,27,'PNG');


	//TRAEMOS LA INFORMACIÓN DE LA VENTA

	$itemVenta = "codigo";
	$valorVenta = isset($_GET['codigo']) ? $_GET['codigo'] : '';
	...
	$pdf->Ln(6);
	$pdf->Cell(140,0,iconv("UTF-8", "ISO-8859-1",""),0,0,'R');
	$pdf->Cell(60,7,iconv("UTF-8", "ISO-8859-1","RUC 20608220233"),'LRT',0,'C');
	$pdf->Ln(7);
	$pdf->Cell(140,0,iconv("UTF-8", "ISO-8859-1",""),0,0,'C');
	$pdf->Cell(60,7,iconv("UTF-8", "ISO-8859-1","FACTURA ELECTRONICA"),'LR',0,'C');
	$pdf->Ln(7);
	$pdf->Cell(140,0,iconv("UTF-8", "ISO-8859-1",""),0,0,'C');
	$pdf->Cell(60,7,iconv("UTF-8", "ISO-8859-1",$valorVenta),'LRB',0,'C');
	$pdf->Ln(-10);

	$pdf->SetFont('Arial','',9);
	$pdf->SetTextColor(39,39,51);
	$pdf->Cell(150,45,iconv("UTF-8", "ISO-8859-1","JR. Manuel Alonso Aguirre N°573 Urb. Lamblaspta El Tambo , Huancayo - JUNÍN"),0,0,'L');
	...
	$pdf->Ln(5);
	$pdf->Cell(200,5,iconv("UTF-8", "ISO-8859-1","RUC                           : ".$DNI),'LR',0,'M');
	$pdf->Ln(5);
	...
	$pdf->Ln(5);
	$pdf->Cell(200,5,iconv("UTF-8", "ISO-8859-1","Provincia                   :"),'LR',0,'M');
	$pdf->Ln(5);
	...
	$pdf->SetFont('Arial', '', 6);
		$pdf->Cell(15,75,iconv("UTF-8", "ISO-8859-1",""),'LB',0,'C');
		$pdf->Cell(30,75,iconv("UTF-8", "ISO-8859-1",""),'LB',0,'C');
		$pdf->Cell(90,75,iconv("UTF-8", "ISO-8859-1",""),'LB',0,'C');
		$pdf->Cell(25,75,iconv("UTF-8", "ISO-8859-1",""),'LB',0,'C');
		$pdf->Cell(20,75,iconv("UTF-8", "ISO-8859-1",""),'LB',0,'C');
		$pdf->Cell(20,75,iconv("UTF-8", "ISO-8859-1",""),'LRB',0,'C');
		$pdf->Ln(70);
	...
	foreach ($productos as $key => $item) {
		...
		$pdf->Cell(15,-136,iconv("UTF-8", "ISO-8859-1",$item["cantidad"]),'',0,'C');
		$pdf->Cell(30,-136,iconv("UTF-8", "ISO-8859-1",$respuestaProducto["codigo_producto"]),'',0,'C');
		$pdf->Cell(90,-136,iconv("UTF-8", "ISO-8859-1",$item["nombre_producto"]),'',0,'L');
		$pdf->Cell(25,-136,iconv("UTF-8", "ISO-8859-1",$respuestaProducto["ubicacion"]),'',0,'R');
		$pdf->Cell(20,-136,iconv("UTF-8", "ISO-8859-1","S/.".$valorUnitario),'',0,'R');
		$pdf->Cell(20,-136,iconv("UTF-8", "ISO-8859-1","S/.".$precioTotal),'',0,'R');
		$pdf->Ln(5);
	...
	$pdf->Image('img/QRtractoleo.png',99,240,10,10,'PNG');
