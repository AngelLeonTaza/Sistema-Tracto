<?php
	...
	$numeroComprobante = $respuestaVenta["codigo"];
	...
	$pdf->Cell(70,10,iconv("UTF-8", "ISO-8859-1","FACTURA DE VENTA"),'LR',0,'C');
	$pdf->Ln(7);
	$pdf->Cell(130,0,iconv("UTF-8", "ISO-8859-1",""),0,0,'C');
	$pdf->Cell(70,10,iconv("UTF-8", "ISO-8859-1","ELECTRONICA"),'LR',0,'C');
	$pdf->Ln(7);
	$pdf->Cell(130,0,iconv("UTF-8", "ISO-8859-1",""),0,0,'C');
	$pdf->Cell(70,10,iconv("UTF-8", "ISO-8859-1",$serieComprobante.'-'.$numeroComprobante),'LRB',0,'C');
	$pdf->Ln(-16);
