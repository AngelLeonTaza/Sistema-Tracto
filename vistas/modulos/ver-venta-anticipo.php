...
<div class="input-group mb-3">
            ...
            <span class="input-group-text"><strong>SERIE DE COMPROBANTE ASIGNADO</strong></span>
            ...
            <?php
                  ...
                  // Imprimir el valor en el input
                  echo '<input type="text" class="form-control" id="nuevoPagoAnticipo" name="nuevoPagoAnticipo" value="'.$codigo.'" readonly>';
            ?>
        ...
        <div class="card">
            <div class="card-body">
                <div class="float-right">
                    ...
                    <input class="ml-2" type="text" value="<?php echo $venta["neto"] ?>" readonly>
                    ...
                    <input class="ml-2" type="text" value="<?php echo $venta["impuesto"] ?>" readonly>
                    ...
                    <input class="ml-2" type="text" value="<?php echo $venta["total"] ?>" readonly>
                    ...
                    <div class="mb-6 text-right">
                    <!-- Detalles Pago 1 -->
                    <label class="ml-2">PAGO INICIAL (ANTICIPO): </label>
                    ...
                    <input class="ml-2" type="text" name="deudaAnticiposVista" value="S/.<?php $deuda = $venta["total"] - $contadorPagos; echo $deuda ?>.00" readonly>


                    
                    <input class="ml-2" type="text" name="deudaAnticipos" value="<?php echo $deuda ?>" readonly hidden>
                    ...
                    <div class="mb-6 text-right">
                    <!-- Detalles Pago 1 -->
                    <label class="ml-2">NUEVO IMPORTE: </label>
                    <input class="ml-2" type="number" pattern="[0-9]*" name="nuevoImporteAnticipo" class="form-control input-lg" placeholder="S/.0.00">
